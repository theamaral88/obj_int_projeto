...
const char* WFpassword = "1amaral1";
const char* mqtt_server = "mqtt.internetecoisas.com.br"; //Broker Internet e Coisas

String clientId = "ESP32CamClient-" + String(random(0xffff), HEX);
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if(String((char*) topic) == "MackMQTT-Emerson"){
    ...
    if(inString=="TaEscuro") digitalWrite(FLASH_LED, HIGH);
...
void reconnect(){
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str(),"72aa269b@228","dc3a7b397429", willTopic, willQoS, willRetain, willMessage, true)){
      ...
      client.publish("MackMQTT-Emerson", "ESP32 CAM Conectado");
      
      // ... and resubscribe
      client.subscribe("MackMQTT-Emerson");
      client.publish("MackMQTT-Emerson", "Inscrito no tópico MQTT!");
...
void setup() {
  ...
  Serial.println("");
  Serial.print("Câmera disponível no ");
